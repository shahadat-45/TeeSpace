...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $amount = Order::where('order_id', $order_id)->first()->total ;
        $post_data = array();
    ...
    public function success(Request $request)
    {
        ...
        $product = OrderProduct::where('order_id' , $order->order_id)->get();
        ...
        Mail::to(Billing::where('order_id', $order->order_id)->first()->email)->send(new invoiceMail($order->order_id));
