	...
	<div class="main-wrapper">
      ...
      <div class="sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('tag.list') }}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="uiComponents">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('sub-category') }}" class="nav-link">SubCategory List</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="advancedUI">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('product.store') }}" class="nav-link">Add Product</a>
                </li>
                <li class="nav-item">
		...
		<div class="page-wrapper">
			...
			<nav class="navbar">
                ...
                @if (Auth::user()->profile_pic)
								<img src="{{ asset('backend') }}/user/{{ Auth::user()->profile_pic }}" alt="profile">
                @else
